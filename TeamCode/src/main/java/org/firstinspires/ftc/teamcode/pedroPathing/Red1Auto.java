...
@Autonomous(name = "Red1Auto", group = "Pedro", preselectTeleOp = "TELEOP_JAVA")
public class Red1Auto extends OpMode {
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(93.627, 96.580)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(217), Math.toRadians(226))
            ...
            Path5 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(93.669, 96.634)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(360), Math.toRadians(222))
            ...
            Path6 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(90.479, 58.811)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(222), Math.toRadians(360))
            ...
            Path8 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(133.569, 58.611),
                                    new Pose(102.576, 56.817),
                                    new Pose(122.424, 84.459),
                                    new Pose(93.483, 96.600)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(360), Math.toRadians(221))
            ...
            Path9 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(112.055, 78.855)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(221))
    ...
    private final Pose startPose = new Pose(122.0, 125.0, Math.toRadians(217));
